...
def train(args):
    ...
    train_dataset = Data(json_path='/home/group6/Voice_Cloning/Mimik/Mimik_Voice_Cloner/ASR/datasets/LibriSpeech/train_tc100.json', sample_rate = 16000, n_feats = 81, specaug_rate = 0.5, specaug_policy = 3,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--valid_file', default='/home/group6/Voice_Cloning/Mimik/Mimik_Voice_Cloner/ASR/datasets/LibriSpeech_WAVS/test_clean_100', required=False, type=str,
